...
| 02 | [Web foundation + health](phase-02-web-app-foundation-and-health.md) | 01 | App Router + next-intl locale routing, semantic Tailwind, env/envelope, `/api/health`, landing | ☐ |
